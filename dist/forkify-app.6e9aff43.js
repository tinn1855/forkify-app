...
})({"hPrMx":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "047d568c6e9aff43";
"use strict";
...
},{}],"3wEfD":[function(require,module,exports,__globalThis) {
...
class RecipeController extends (0, _controllerJsDefault.default) {
    ...
    async listRecipes() {
        const recipes = await (0, _recipeJsDefault.default).listRecipes();
        // List all recipes
...
},{"../views/ListRecipesView.js":"cPpA9","../core/Controller.js":"dKLs9","../models/Recipe.js":"krCpr","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cPpA9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class ListRecipesView extends (0, _viewJsDefault.default) {
    ...
    render(recipes) {
        this.addMarkup(`
        <ul>
          ${recipes.map((recipe)=>`<li data-id="${recipe.id}" onclick="RecipeController.showRecipe('${recipe.id}')">${recipe.title}</li>`).join('')}
        </ul>
    `);
    }
}
...
},{"../core/View.js":"8RTrZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8RTrZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    #view;
    constructor(viewId){
        ...
        if (!this.#view) throw new Error('viewId not found');
    }
    getView() {
        return this.#view;
    }
...
},{}],"dKLs9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Controller {
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["hPrMx","3wEfD"], "3wEfD", "parcelRequire3a11", {})

//# sourceMappingURL=forkify-app.6e9aff43.js.map
